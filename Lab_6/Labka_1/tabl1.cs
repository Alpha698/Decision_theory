...
namespace Labka_1
{
    public partial class tabl1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string ver1 = textBox29.Text;
            string ver2 = textBox30.Text;
            string ver3 = textBox31.Text;
            string ver4 = textBox32.Text;
            string ver5 = textBox33.Text;
            double vero1 = Convert.ToDouble(ver1);
            double vero2 = Convert.ToDouble(ver2);
            double vero3 = Convert.ToDouble(ver3);
            double vero4 = Convert.ToDouble(ver4);
            double vero5 = Convert.ToDouble(ver5);
            //ПЕРВАЯ ЯЧЕЙКА
            double[] array2 = { a, a2 };
            ...
            double sums1 = ras + ras6 + ras11 + ras16 + ras21;
            double sums2 = ras2 + ras7 + ras12 + ras17 + ras22;
            double sums3 = ras3 + ras8 + ras13 + ras18 + ras23;
            double sums4 = ras4 + ras9 + ras14 + ras19 + ras24;
            double sums5 = ras5 + ras10 + ras15 + ras20 + ras25;
            int kol = 5;
            double sums1pod1 = sums1 / kol;
            double sums1pod2 = sums2 / kol;
            double sums1pod3 = sums3 / kol;
            double sums1pod4 = sums4 / kol;
            double sums1pod5 = sums5 / kol;

            textBox44.Text = sums1pod1.ToString();
            textBox45.Text = sums1pod2.ToString();
            textBox46.Text = sums1pod3.ToString();
            textBox47.Text = sums1pod4.ToString();
            textBox48.Text = sums1pod5.ToString();

            double[] array51 = { sums1pod1, sums1pod2, sums1pod3, sums1pod4, sums1pod5 };
            double max26 = double.MinValue;
            for (int i = 0; i < array51.Length; i++)
            {
                if (array51[i] > max26)
                    max26 = array51[i];
            }
            label7.Text = max26.ToString();

            //dataGridView1.Rows.Add(sums1pod1, sums1pod2, sums1pod3, sred, mera1);
            //dataGridView1.Rows.Add(sums2pod1, sums2pod2, sums2pod3, sred2, mera2);
            //dataGridView1.Rows.Add(sums3pod1, sums3pod2, sums3pod3, sred3, mera3);

            Form1.max26 = max26;

            Form1.sums1pod1 = sums1pod1;
            Form1.sums1pod2 = sums1pod2;
            Form1.sums1pod3 = sums1pod3;
            Form1.sums1pod4 = sums1pod4;
            Form1.sums1pod5 = sums1pod5;
            //Form1.sred2two = sred2;
            //Form1.sred3two = sred3;

        }

        private void tabl1_Load(object sender, EventArgs e)
        {
