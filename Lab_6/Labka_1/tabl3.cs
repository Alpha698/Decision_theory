...
namespace Labka_1
{
    public partial class tabl3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            double[] array52 = { ras, ras6, ras11, ras16, ras21 };
            ...
            double[] array152 = { ras2, ras7, ras12, ras17, ras22 };
            double max127 = double.MinValue;
            for (int i = 0; i < array152.Length; i++)
            {
                if (array152[i] > max127)
                    max127 = array152[i];
            }
            double[] array252 = { ras3, ras8, ras13, ras18, ras23 };
            double max227 = double.MinValue;
            for (int i = 0; i < array252.Length; i++)
            {
                if (array252[i] > max227)
                    max227 = array252[i];
            }
            double[] array352 = { ras4, ras9, ras14, ras19, ras24 };
            double max327 = double.MinValue;
            for (int i = 0; i < array352.Length; i++)
            {
                if (array352[i] > max327)
                    max327 = array352[i];
            }
            double[] array452 = { ras5, ras10, ras15, ras20, ras25 };
            double max427 = double.MinValue;
            for (int i = 0; i < array452.Length; i++)
            {
                if (array452[i] > max427)
                    max427 = array452[i];
            }

            string aa = textBox44.Text;
            double aak = Convert.ToDouble(aa);
            //3-ий столбец таблицы
            double max32 = aak * max27 + (1 -aak)*min125;
            double max33 = aak * max127 + (1 - aak) * min225;
            double max34 = aak * max227 + (1 - aak) * min325;
            double max35 = aak * max327 + (1 - aak) * min425;
            double max36 = aak * max427 + (1 - aak) * min525;
            ...
            dataGridView1.Rows.Add(min125, max27, max32);
            dataGridView1.Rows.Add(min225, max127, max33);
            dataGridView1.Rows.Add(min325, max227, max34);
            dataGridView1.Rows.Add(min425, max327, max35);
            dataGridView1.Rows.Add(min525, max427, max36);
